 ...
 * @author ACER
 */
public class LoadSubjectListForCreateTestServlet extends HttpServlet {

    private final String CREATE_TEST_PAGE = "create_test.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("LoadSubjectListForCreateTestServlet:" + ex.getMessage());
        } finally {
