 ...
 * @author ACER
 */
public class LoadSubjectListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("LoadSubjectListServlet:" + ex.getMessage());
        } finally {
            request.getRequestDispatcher(CREATE_QUESTION_PAGE).forward(request, response);
        }
    }
